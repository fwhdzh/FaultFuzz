...
echo "sh $SCRIPT_DIR/restartAllDockers.sh"
...
echo "sh $SCRIPT_DIR/startHDFS.sh"
sh $SCRIPT_DIR/startHDFS.sh
...
#sh clearRst.sh
echo "sh $SCRIPT_DIR/clearDockerRst.sh"
sh $SCRIPT_DIR/clearDockerRst.sh
echo "sh $SCRIPT_DIR/clearHB.sh"
