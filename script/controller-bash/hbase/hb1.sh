...
#fav-jre-inst/bin/java $PHOS_OPTS -cp HBaseCases-0.0.1-SNAPSHOT.jar com.iscas.HBaseCases.NormalTestNew 172.25.0.8 11181 check nullcrash nullstart /data/gaoyu/faultfuzzer/hbase-2.4.8-c1/failTest.sh
