...
DEST_DIR=/data/fengwenhan/data/faultfuzz_hbase_jar_and_start

cp /home/fengwenhan/code/crashfuzz-ctrl/ctrl/target/FaultFuzz-ctrl-0.0.1-SNAPSHOT.jar $DEST_DIR
