java -cp /home/fengwenhan/code/crashfuzz-ctrl/target/CCrashFuzzer-0.0.1-SNAPSHOT.jar edu.iscas.CCrashFuzzer.CloudFuzzMain 12090 "/home/fengwenhan/code/crashfuzz-ctrl/script/controller-bash/zk.properties"
#sh snapshotState.sh
