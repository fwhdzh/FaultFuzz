...
info=$1
#rst=$(docker exec -it C1NN bin/bash -ic "cd /home/gaoyu/evaluation/hadoop-3.3.5 && bin/hdfs haadmin -getServiceState nn2")
...
#rst=$(docker exec -it C1NN bin/bash -ic "cd /home/gaoyu/evaluation/hadoop-3.3.5 && bin/hdfs haadmin -getServiceState nn1")
#got=$( echo "$rst" | grep "$info" )
#if [[ "$got" == "" ]]; then
#  break
#fi
