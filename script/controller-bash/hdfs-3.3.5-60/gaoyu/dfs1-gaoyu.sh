...
java -cp FaultFuzz-workload-HDFSCasesV3-0.0.1-SNAPSHOT.jar edu.iscas.tcse.HDFSCasesV3.NormalTest check start.sh stop.sh /data1/gaoyu/faultfuzzer/hdfs-3.3.1-c1-new/failTest.sh
#fav-jre-inst/bin/java $PHOS_OPTS -cp FaultFuzz-workload-HDFSCasesV3-0.0.1-SNAPSHOT.jar edu.iscas.tcse.HDFSCasesV3.NormalTest check start.sh stop.sh /data1/gaoyu/faultfuzzer/hdfs-3.3.1-c1-new/failTest.sh
