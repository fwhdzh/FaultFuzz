java -cp /home/fengwenhan/code/crashfuzz-ctrl/faultfuzz/target/FaultFuzz-0.0.1-SNAPSHOT.jar edu.iscas.tcse.faultfuzz.CloudFuzzMain 12090 "/home/fengwenhan/code/crashfuzz-ctrl/script/controller-bash/hdfs-3.3.5-60/dfs.properties"
#sh snapshotState.sh
