function start {
        ...
        docker exec -t $nodeName /bin/bash -ic "iptables-restore < /observer/iptables-rules"

        docker exec -t $nodeName /bin/bash -ic 'cd /zookeeper-3.6.3/ && bin/zkServer.sh start'
