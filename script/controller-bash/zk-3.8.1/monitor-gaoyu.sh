...
docker cp C1ZK1:/home/gaoyu/evaluation/zk-3.8.1/logs $1/monitor/C1ZK1
docker cp C1ZK1:/home/gaoyu/evaluation/zk-3.8.1/zkData $1/monitor/C1ZK1

mkdir $1/monitor/C1ZK2
docker cp C1ZK2:/home/gaoyu/evaluation/zk-3.8.1/logs $1/monitor/C1ZK2
docker cp C1ZK2:/home/gaoyu/evaluation/zk-3.8.1/zkData $1/monitor/C1ZK2

mkdir $1/monitor/C1ZK3
docker cp C1ZK3:/home/gaoyu/evaluation/zk-3.8.1/logs $1/monitor/C1ZK3
docker cp C1ZK3:/home/gaoyu/evaluation/zk-3.8.1/zkData  $1/monitor/C1ZK3

mkdir $1/monitor/C1ZK4
docker cp C1ZK4:/home/gaoyu/evaluation/zk-3.8.1/logs $1/monitor/C1ZK4
docker cp C1ZK4:/home/gaoyu/evaluation/zk-3.8.1/zkData  $1/monitor/C1ZK4

mkdir $1/monitor/C1ZK5
docker cp C1ZK5:/home/gaoyu/evaluation/zk-3.8.1/logs $1/monitor/C1ZK5
docker cp C1ZK5:/home/gaoyu/evaluation/zk-3.8.1/zkData  $1/monitor/C1ZK5
...
java -jar jacoco-0.8.7/lib/jacococli.jar report $1/cov/merged.exec --classfiles $FAV_HOME/evaluation/zk-3.8.1/lib/zookeeper-3.8.1.jar --xml $1/cov/cov.xml

java -jar jacoco-0.8.7/lib/jacococli.jar report $1/cov/merged.exec --classfiles $FAV_HOME/evaluation/zk-3.8.1/lib/zookeeper-3.8.1.jar --html $1/cov/cov-page
COMMENT
