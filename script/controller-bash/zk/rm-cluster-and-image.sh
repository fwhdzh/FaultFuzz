...
echo "docker-compose -p fav-zk -f ~/code/crashfuzz-ctrl/script/controller-bash/zk/zk-compose.yaml down"
docker-compose -p fav-zk -f ~/code/crashfuzz-ctrl/script/controller-bash/zk/zk-compose.yaml down
