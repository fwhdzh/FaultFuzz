java -cp /home/fengwenhan/code/crashfuzz-ctrl/ctrl/target/FaultFuzz-ctrl-0.0.1-SNAPSHOT.jar edu.iscas.tcse.faultfuzz.ctrl.CloudFuzzMain 12090 "/home/fengwenhan/code/crashfuzz-ctrl/script/controller-bash/hdfs/dfs.properties"
#sh snapshotState.sh
