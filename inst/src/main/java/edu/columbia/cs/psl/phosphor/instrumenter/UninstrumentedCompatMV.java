...
//        super.visitFrame(type, nLocal, newLocal, nStack, newStack);
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
        if(PhosphorInspector.isIgnoredClass(owner)) {
        ...
        if(PhosphorInspector.isIgnoredClass(owner) || Instrumenter.isIgnoredMethod(owner, name, desc)) {
            super.visitMethodInsn(opcode, owner, name, desc, itf);
            return;
        }
        ...
        if(!PhosphorInspector.isIgnoredClass(owner) && !owner.startsWith("[") && !isCalledOnArrayType) {
