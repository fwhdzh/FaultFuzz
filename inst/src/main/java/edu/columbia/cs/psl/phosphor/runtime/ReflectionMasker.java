...
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.ADD_TYPE_PARAMS;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.ENUM_VALUE_OF;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FIX_ALL_ARGS_CONSTRUCTOR;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FIX_ALL_ARGS_CONSTRUCTOR_CONTROL;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FIX_ALL_ARGS_METHOD;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FIX_ALL_ARGS_METHOD_CONTROL;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_DECLARED_METHOD;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_METHOD;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_ORIGINAL_CLASS;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_ORIGINAL_CLASS_OBJECT_OUTPUT_STREAM;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_ORIGINAL_CONSTRUCTOR;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.GET_ORIGINAL_METHOD;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.IS_INSTANCE;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.REMOVE_EXTRA_STACK_TRACE_ELEMENTS;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.REMOVE_TAINTED_CONSTRUCTORS;
...
public class ReflectionMasker {
    ...
    private static boolean isIgnoredClass(Class<?> clazz) {
        return clazz != null && (PhosphorInspector.isIgnoredClass(clazz.getName().replace('.', '/'))
