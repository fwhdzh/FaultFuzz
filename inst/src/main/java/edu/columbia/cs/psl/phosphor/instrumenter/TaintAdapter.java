        ...
        switch(n) {
            ...
            case 1:
                ...
                if(top == Opcodes.LONG || top == Opcodes.DOUBLE || top == Opcodes.TOP) {
                    /*
                     * TOP is for the second part of a long/double.
                     * We need to swap the top two elements, then pop the top, then unbox, then swap the top two elements again
                     * (so that the long/double is on top)
                     */
