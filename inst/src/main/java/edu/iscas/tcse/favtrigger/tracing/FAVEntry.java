...
public class FAVEntry implements Serializable {
	...
	public FAVEntry(long timestamp, long threadId, int threadObjId, String path, List<String> callstack) {
		super();
	...
	public FAVEntry(long timestamp, long threadId, int threadObjId, String path, Taint taint, List<String> callstack) {
		...
		this(timestamp, threadId, threadObjId, path, callstack);
		this.TAINT = taint;
	}
	...
	public int hashCode() {
		...
		res = 31 * res + (int)(procID^(procID>>>32));
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof FAVEntry) {
			...
			return this.ip.equals(e.ip) && this.procID == e.procID &&
