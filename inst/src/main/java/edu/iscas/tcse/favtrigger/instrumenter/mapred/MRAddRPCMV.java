...
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_NEW_TAINT;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_RECORD_OR_TRIGGER_TAINTEDOBJ;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_TAINT_ARRAY_FULLY;
...
//        super.visitMethodInsn(INVOKESTATIC, "edu/iscas/tcse/favtrigger/instrumenter/mapred/MRTestMV", "test", "()V", false);
    	if(name.endsWith("$$FAV") && Configuration.USE_FAULT_FUZZ && Configuration.FOR_MR) {
