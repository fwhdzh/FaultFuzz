...
public class FWHZKTrackingMV extends TaintAdapter implements Opcodes {
    ...
    public FWHZKTrackingMV(MethodVisitor mv, int access, String owner, String name, String descriptor, String signature,
