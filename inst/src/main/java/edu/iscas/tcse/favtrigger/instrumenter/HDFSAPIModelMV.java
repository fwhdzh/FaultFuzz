...
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_RECORD_OR_TRIGGER;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_RECORD_OR_TRIGGER_TAINT;
import static edu.columbia.cs.psl.phosphor.instrumenter.TaintMethodRecord.FAV_APP_TAINT_BYTES;
...
//        }
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean isInterface) {
    	if(Configuration.USE_FAULT_FUZZ && Configuration.HDFS_API) {
    		if((owner.equals("org/apache/hadoop/fs/FSDataInputStream") || owner.equals("org/apache/hadoop/hdfs/client/HdfsDataInputStream")
...
//        super.visitVarInsn(ASTORE, path);
    ...
    public void visitInsn(int opcode) {
        // TODO Auto-generated method stub
        //if(opcode == ARETURN) {
    	if(Configuration.USE_FAULT_FUZZ && Configuration.HDFS_API && OpcodesUtil.isReturnOpcode(opcode)) {
