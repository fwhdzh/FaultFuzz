...
public class NIOTrackingMV extends TaintAdapter implements Opcodes {
    ...
    public void visitCode() {
    	super.visitCode();
    	if(NativeMethodInspector.isSocketChannelWrite(this.owner, this.name, this.desc)
        ||NativeMethodInspector.isSocketChannelRead(this.owner, this.name, this.desc)){
    ...
    public static String getNIOWritePath(String path) {
    	if(Configuration.USE_FAULT_FUZZ && Configuration.JDK_MSG && Configuration.USE_MSGID) {
    ...
    public static void adhereTaintsToBytes(LazyByteArrayObjTags obj, int off, int len, String cname, String mname, String desc, String type, String tag, String remoteIP) {
    	if(Configuration.USE_FAULT_FUZZ && Configuration.JDK_MSG) {
