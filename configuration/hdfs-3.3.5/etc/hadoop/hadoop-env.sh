...
export HADOOP_HOME=/home/gaoyu/evaluation/hadoop-3.3.5
...
export HDFS_BALANCER_OPTS="$PHOS_OPTS $TIME_OPTS"
export HDFS_MOVER_OPTS="$PHOS_OPTS $TIME_OPTS"
export HDFS_DFSROUTER_OPTS="$PHOS_OPTS $TIME_OPTS"
export HDFS_STORAGECONTAINERMANAGER_OPTS="$PHOS_OPTS $TIME_OPTS"
export HDFS_NFS3_OPTS="$PHOS_OPTS $TIME_OPTS"
# export HDFS_JOURNALNODE_OPTS="$FAV_OPTS $TIME_OPTS"
export HDFS_JOURNALNODE_OPTS="$PHOS_OPTS $TIME_OPTS"
