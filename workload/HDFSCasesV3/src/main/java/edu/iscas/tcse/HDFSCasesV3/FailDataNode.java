...
public class FailDataNode {
	...
	public static void main(String[] args) {
		...
		long curTime = 0;
		try {
			FSDataOutputStream fsDataOutputStream = fs.create(new Path("/usr/root/test"));

			stopDataNode();
			Logger.log(testName, " stop a data node.");
...
//	        bufferedWriter.newLine();
	...
	public static ArrayList<String> stopDataNode() {
		if(stopNodeSH != null) {
